...
namespace ContestantRegister.Models
{
    public class ApplicationUser : IdentityUser, IHasId<string>
    {
        ...
        /// <summary>
        /// Поле необязательно для школьника итренера школьников, но обязательно для студента и тренера студентов
        /// </summary>
        [MaxLength(50)]
        ...
        public ICollection<TeamContestRegistration> ContestRegistrationsTrainer2 { get; set; }
        public ICollection<TeamContestRegistration> ContestRegistrationsTrainer3 { get; set; }
