...
namespace ContestantRegister.Cqrs.Features.Frontend.Account.CommandHandlers
{
    public class LoginCommandHandler : ICommandHandler<LoginCommand>
    {
        ...
        {
            var user = await _userManager.FindByEmailAsync(command.ViewModel.Email);
            ...
            var result = await _signInManager.PasswordSignInAsync(command.ViewModel.Email, command.ViewModel.Password, command.ViewModel.RememberMe, lockoutOnFailure: false);
