...
namespace ContestantRegister.Cqrs.Features.Admin.CompClasses.Utils
{
    public static class CompClassesCqrsRegistrations
    {
        public static void RegisterCompClassesServices(this IServiceCollection services)
        {
            ...
            services.AddTransient<IQueryHandler<GetEntityByIdQuery<CompClass, int>, CompClass>, GetEntityByIdQueryHandler<CompClass, int>>();
            services.AddTransient<IQueryHandler<GetEntityByIdForDeleteQuery<CompClass, int>, CompClass>, GetEntityByIdForDeleteQueryHandler<CompClass, int>>();
            ...
            services.AddTransient<ICommandHandler<DeleteEntityByIdCommand<CompClass, int>>, DeleteEntityByIdCommandHandler<CompClass, int>>();
